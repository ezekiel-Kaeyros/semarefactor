...
import { AddListNode, AddTextNode, ImageNode } from './componentsNodes';
import { useStoreApi } from 'reactflow';
import { NodeDataType, useSenarioCreate } from '@/zustand_store';

function QuestionListTypeNode({ data, isConnectable }: QuestionTypeNodeType) {
        ...
        <div className=" bg-mainDark w-full p-2 ">
          ...
          <div className=" w-full flex flex-wrap  gap-x-1 gap-y-2">
            ...
            <ButtonNode
              titre="Add item"
              fc={addButton}
              conditionDisable={content.length > 14}
              disabled={content.length > 14}
